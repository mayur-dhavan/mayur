...
<nav id="sidebar" class='mx-lt-5 bg-info' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=feedback" class="nav-item"><span class='icon-field'><i class=""></i></span>Feedback Form</a>
				<a href="index.php?page=pay_fees" class="nav-item"><span class='icon-field'><i class=""></i></span>Pay Fees</a>
				<!--<a href="logs.php" class="nav-item"><span class='icon-field'><i class=""></i></span>Log Details</a>-->
			<?php endif; ?>
		</div>
